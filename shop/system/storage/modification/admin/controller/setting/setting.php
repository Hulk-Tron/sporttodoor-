...
// Tasawk Languages
        $data['entry_address_en'] = $this->language->get('entry_address_en');
...
// English Address
        if (isset($this->request->post['config_address_en'])) {
          $data['config_address_en'] = $this->request->post['config_address_en'];
        } else {
          $data['config_address_en'] = $this->config->get('config_address_en');
        }
      // End English Address
      // Social
        ...
        // end Social
        // footer welcome Page
        if (isset($this->request->post['config_footerPages'])) {
          $data['config_footerPages'] = $this->request->post['config_footerPages'];
        } else {
          $data['config_footerPages'] = $this->config->get('config_footerPages');
        }

        $data['footerPages'] = array();
        $this->load->model('catalog/information');
        $footerPagess = $this->model_catalog_information->getInformations();
        foreach ($footerPagess as $footerPages) {
          $data['footerPages'][] = array(
            'information_id' => $footerPages['information_id'],
            'title'          => $footerPages['title']
          );
        }
      // End footer welcome Page
