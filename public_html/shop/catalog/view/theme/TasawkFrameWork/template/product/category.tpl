...
<div class="item">
                                        ...
                                        <div class="modal-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                        	<div id="colorize_loading" style="display:none"><img src="catalog/view/theme/default/image/colorize_loading.gif" /></div>
                                                            <img id="zoom_09" src="<?php echo $product['thumb'] ?>" data-zoom-image="<?php echo $product['thumb'] ?>" class="img-responsive image<?php echo $product['product_id'];?>">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <select onchange="refreshimage(this.value, <?php echo $product['product_id'];?>, colorize_thumb<?php echo $product['product_id'];?>, colorize_popup<?php echo $product['product_id'];?> );" name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
...
var colorize_thumb<?php echo $product['product_id'];?>='<?php echo $product['thumb']; ?>';
var colorize_popup<?php echo $product['product_id'];?>='<?php echo $product['thumb']; ?>';
$( document ).ready(function() {
    $('#input-option<?php echo $option['product_option_id']; ?>').trigger('change');
});
//--></script>
            <?php } ?>
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
            <div class="row">
                <div class="col-sm-4"><label class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label></div>
                <div class="col-sm-8">
...
<script type="text/javascript"><!--
function refreshimage(color, id, colorize_thumb, colorize_popup){
	if(color==''){
		$('.image'+id).attr('src',colorize_thumb);
		$('.image'+id).parent().attr('href',colorize_popup);
	}else{
		$('#colorize_loading img').css('width',$('.image'+id).css('width'));
		$('#colorize_loading img').css('height',$('.image'+id).css('height'));	
		...
		$.ajax({
			...
			success: function(json) {
				if(json.success=='ok'){
					$('.image'+id).attr('src',json.imagesrc);
					$('.image'+id).parent().attr('href',json.bigimagesrc);
				}
