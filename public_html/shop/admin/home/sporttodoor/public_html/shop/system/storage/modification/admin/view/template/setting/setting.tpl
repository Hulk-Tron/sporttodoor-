...
<li><a href="#tab-tasawk" data-toggle="tab">اعدادات الرئيسية</a></li>
          </ul>
...
<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-address_en"><?php echo $entry_address_en; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_address_en" placeholder="<?php echo $entry_address_en; ?>" rows="5" id="input-address_en" class="form-control"><?php echo $config_address_en; ?></textarea>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="tab-pane" id="tab-tasawk">
          <div class="form-group">
            <label class="col-sm-2 control-label"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_location; ?>">الصفحة بالفوتر</span></label>
            <div class="col-sm-10">
              <select name="config_footerPages" id="input-footerPages" class="form-control">
                <?php foreach ($footerPages as $wel) { ?>
                <?php if ($wel['information_id'] == $config_footerPages) { ?>
                <option value="<?php echo $wel['information_id']; ?>" selected="selected"><?php echo $wel['title']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $wel['information_id']; ?>"><?php echo $wel['title']; ?></option>
                <?php } ?>
                <?php } ?>
              </select>
            </div>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-fax">رابط  facebook</label>
            <div class="col-sm-10">
              <input type="text" name="config_facebook" value="<?php echo $config_facebook; ?>" placeholder="رقم  facebook" id="input-facebook" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-twitter">رابط twitter</label>
            <div class="col-sm-10">
              <input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" placeholder="رابط twitter" id="input-twitter" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-insta">رابط instagram</label>
            <div class="col-sm-10">
              <input type="text" name="config_insta" value="<?php echo $config_insta; ?>" placeholder="رابط instagram" id="input-insta" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-pinterest">رابط pinterest</label>
            <div class="col-sm-10">
              <input type="text" name="config_pinterest" value="<?php echo $config_pinterest; ?>" placeholder="رابط pinterest" id="input-pinterest" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-whatsapp">رقم الـ whatsapp</label>
            <div class="col-sm-10">
              <input type="text" name="config_whatsapp" value="<?php echo $config_whatsapp; ?>" placeholder="رقم الـ whatsapp" id="input-whatsapp" class="form-control" />
            </div>
          </div>
        </div>
